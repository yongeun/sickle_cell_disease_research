...
## Fit with the REACH Awards and expected impact

The REACH Awards back family physicians positioned to close gaps in CKM care, and this project puts a primary-care question — should we reach for a GLP-1 agonist earlier to change where a patient's CKM is headed — to a nationally diverse dataset at the moment coverage makes the question real for millions of patients. A signal that early treatment slows progression or drives regression would support acting sooner in prevention; a null or attenuated signal would sharpen stewardship and target scarce access where it helps most. Either result is directly usable at the point of care, and both establish the pilot foundation and preliminary data for a larger AHA or NIH proposal.
